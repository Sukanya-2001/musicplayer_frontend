  ...
  return (
    <Box>
      <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <Typography variant="body1" fontWeight="bold" sx={{ fontSize: "25px",  padding: "30px" }}>
          Popular <Box component="span" color="rgb(255 14 188)">Artists</Box>
        </Typography>
        <Typography variant="body1" color="rgb(255 14 188)" sx={{ cursor: "pointer", padding: "30px" }}>
          + View all
        </Typography>
      </Box>
